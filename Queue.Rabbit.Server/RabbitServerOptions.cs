...
public record RabbitConsumerOption
{
    public uint ParallelCount { get; set; } = 1;
    public string ConsumerTag { get; set; } = "tag-unset";
}

public class RabbitServerOptions
{
    public RabbitConsumerOption Consumer { get; set; } = new RabbitConsumerOption();
